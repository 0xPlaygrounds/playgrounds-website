...
const MainArticle = ({ className = "" }: { className?: string }) => (
    <div className={`flex-shrink-0 w-[280px] lg:w-[528px] flex gap-y-6 flex-col group cursor-pointer ${className}`}>
        ...
        <div className="flex flex-col">
            <span className="text-[18px] md:text-[28px] group-hover:underline transition-all duration-300">Performance improvements</span>
            <span className="text-[#808080] text-[14px] md:text-base">We&apos;ve enhanced our platforms to bring you the best possible experience. Check out the latest improvements.</span>
        </div>
    </div>
)

const Article = ({ className = "" }: { className?: string }) => (
    <div className={`flex-shrink-0 w-[280px] md:w-full flex gap-y-6 md:gap-y-2 flex-col md:flex-row md:items-center md:gap-x-4 group cursor-pointer ${className}`}>
        ...
        <div className="flex gap-y-2 flex-col">
            <span className="text-[18px] group-hover:underline transition-all duration-300">Update to our features</span>
            <span className="text-[#808080] text-[14px] md:text-base">We&apos;ve been working tirelessly to bring you the best version of our platforms. Take a look at our new features.</span>
        </div>
    </div>
)
